                        ...
                        >
                            <thead>
                                <tr color="primary">
                                    ...
                                    <th class="text-left">存储用量</th>
                                    <th class="text-left">对象数量</th>
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="text-center">
                                        <v-btn variant="plain" color="primary">详情</v-btn>
                                        <v-btn variant="plain" color="primary">下载</v-btn>
                                        <v-btn variant="plain" color="primary">删除</v-btn>
                                    </td>
                                </tr>
                            </tbody>
                        </v-table>
