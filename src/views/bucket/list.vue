                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="text-center">
                                    ...
                                    <v-btn variant="plain" color="primary" @click="deleteBucket(item.id, index)">删除</v-btn>
                                </td>
                            </tr>
                        </tbody>
                    </v-table>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="text-center">
                                    <!-- <v-btn variant="plain" color="primary" @click="toDetail(item.id, item.name)">详情</v-btn> -->
                                    <!-- <v-btn variant="plain" color="primary">下载</v-btn> -->
                                    <v-btn variant="plain" color="primary" @click="recoverBucket(item.id, index)">恢复</v-btn>
                                </td>
                            </tr>
                        </tbody>
                    </v-table>
...
export default {
    ...
    methods: {
        ...
        loadDeletedBucket() {
            this.r.getDeletedBucketList().then(res => {
                console.log(res)
                this.deletedItems = res.data.bucketList
                console.log(this.deletedItems)
            })
        },
        deleteBucket(id, index) {
            this.r.deleteBucket(id).then(res => {
                console.log(res)
